...
defined('FOOT') or define('FOOT', FOOT_ . '/sbu/');
defined('FOOTBASIC') or define('FOOTBASIC', FOOT_ . '/sbu/basicClasses/');
defined('FOOTCLASS') or define('FOOTCLASS', FOOT_ . '/sbu/classes/');
defined('FOOTController') or define('FOOTController', FOOT_ . '/sbu/publicController/');
//defined('URLController') or define('URLController', 'http://localhost/sbu/');
defined('URLImageController') or define('URLImageController', 'http://112.124.25.155/sbuAdmin/uploadFile/team');
defined('URLController') or define('URLController', 'http://112.124.25.155/sbu/');
...
$smarty->assign('URLImageController', URLImageController);
